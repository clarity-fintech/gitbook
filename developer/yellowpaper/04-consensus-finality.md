...
Consensus, synchronization, finality, and verifier model Moniversion theory and Moniversive recursion HELIX execution, liquidity routing, and safety gates Tokenomics and supply integrity Wallets, APIs, developers, and node infrastructure Security architecture and resilience layers Validation evidence and implementation status Glossary, references, and appendices 1.
