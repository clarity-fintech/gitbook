# `moniversive/migrated/python/clrty-site/tests/test_links.mis`

> Generated 2026-07-26T17:24:53Z · module **`PythonClrtySiteTestsTestLinks`** · 30 lines

```bash
bin/misc moniversive/migrated/python/clrty-site/tests/test_links.mis --check --compact-letters
```
...
// Migrated from python/clrty-site/tests/test_links.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module PythonClrtySiteTestsTestLinks {

  embed gates 3..=6 {
    context: "MIS cutover of python/clrty-site/tests/test_links.py on clrty-1";
