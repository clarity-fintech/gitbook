# `moniversive/migrated/scripts/clarity_docs/mcp_nav_agent_batch.mis`

> Generated 2026-07-26T17:24:53Z · module **`ScriptsClarityDocsMcpNavAgentBatch`** · 30 lines

```bash
bin/misc moniversive/migrated/scripts/clarity_docs/mcp_nav_agent_batch.mis --check --compact-letters
```
...
// Migrated from scripts/clarity_docs/mcp_nav_agent_batch.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsClarityDocsMcpNavAgentBatch {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/clarity_docs/mcp_nav_agent_batch.py on clrty-1";
