# `moniversive/migrated/python/clrty-ohp/src/clrty_ohp/__main__.mis`

> Generated 2026-07-26T17:24:53Z · module **`PythonClrtyOhpSrcClrtyOhpMain`** · 30 lines

```bash
bin/misc moniversive/migrated/python/clrty-ohp/src/clrty_ohp/__main__.mis --check --compact-letters
```
...
// Migrated from python/clrty-ohp/src/clrty_ohp/__main__.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module PythonClrtyOhpSrcClrtyOhpMain {

  embed gates 3..=6 {
    context: "MIS cutover of python/clrty-ohp/src/clrty_ohp/__main__.py on clrty-1";
