# `moniversive/migrated/scripts/integrations/generate_platform_adapters.mis`

> Generated 2026-07-26T17:24:53Z · module **`ScriptsIntegrationsGeneratePlatformAdapters`** · 30 lines

```bash
bin/misc moniversive/migrated/scripts/integrations/generate_platform_adapters.mis --check --compact-letters
```
...
// Migrated from scripts/integrations/generate_platform_adapters.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsIntegrationsGeneratePlatformAdapters {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/integrations/generate_platform_adapters.py on clrty-1";
