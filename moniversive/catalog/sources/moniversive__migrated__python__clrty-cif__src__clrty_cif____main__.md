# `moniversive/migrated/python/clrty-cif/src/clrty_cif/__main__.mis`

> Generated 2026-07-26T17:14:13Z · module **`PythonClrtyCifSrcClrtyCifMain`** · 30 lines

```bash
bin/misc moniversive/migrated/python/clrty-cif/src/clrty_cif/__main__.mis --check --compact-letters
```
...
// Migrated from python/clrty-cif/src/clrty_cif/__main__.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module PythonClrtyCifSrcClrtyCifMain {

  embed gates 3..=6 {
    context: "MIS cutover of python/clrty-cif/src/clrty_cif/__main__.py on clrty-1";
