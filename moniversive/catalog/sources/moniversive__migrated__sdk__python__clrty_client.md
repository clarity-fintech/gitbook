# `moniversive/migrated/sdk/python/clrty_client.mis`

> Generated 2026-07-26T17:14:13Z · module **`SdkPythonClrtyClient`** · 30 lines

```bash
bin/misc moniversive/migrated/sdk/python/clrty_client.mis --check --compact-letters
```
...
// Migrated from sdk/python/clrty_client.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module SdkPythonClrtyClient {

  embed gates 3..=6 {
    context: "MIS cutover of sdk/python/clrty_client.py on clrty-1";
