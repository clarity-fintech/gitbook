...
// Migrated from scripts/clarity_docs/publish_new_pages.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsClarityDocsPublishNewPages {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/clarity_docs/publish_new_pages.py on clrty-1";
