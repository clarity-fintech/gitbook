# `moniversive/migrated/scripts/clrtynet/run_inventory_commands.mis`

> Generated 2026-07-26T17:24:53Z · module **`ScriptsClrtynetRunInventoryCommands`** · 30 lines

```bash
bin/misc moniversive/migrated/scripts/clrtynet/run_inventory_commands.mis --check --compact-letters
```
...
// Migrated from scripts/clrtynet/run_inventory_commands.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsClrtynetRunInventoryCommands {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/clrtynet/run_inventory_commands.py on clrty-1";
