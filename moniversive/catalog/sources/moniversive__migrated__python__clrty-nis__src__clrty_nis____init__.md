# `moniversive/migrated/python/clrty-nis/src/clrty_nis/__init__.mis`

> Generated 2026-07-26T17:14:13Z · module **`PythonClrtyNisSrcClrtyNisInit`** · 30 lines

```bash
bin/misc moniversive/migrated/python/clrty-nis/src/clrty_nis/__init__.mis --check --compact-letters
```
...
// Migrated from python/clrty-nis/src/clrty_nis/__init__.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module PythonClrtyNisSrcClrtyNisInit {

  embed gates 3..=6 {
    context: "MIS cutover of python/clrty-nis/src/clrty_nis/__init__.py on clrty-1";
