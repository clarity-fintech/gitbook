# `moniversive/migrated/sdk/python/clrty_boot.mis`

> Generated 2026-07-26T17:24:53Z · module **`SdkPythonClrtyBoot`** · 30 lines

```bash
bin/misc moniversive/migrated/sdk/python/clrty_boot.mis --check --compact-letters
```
...
// Migrated from sdk/python/clrty_boot.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module SdkPythonClrtyBoot {

  embed gates 3..=6 {
    context: "MIS cutover of sdk/python/clrty_boot.py on clrty-1";
