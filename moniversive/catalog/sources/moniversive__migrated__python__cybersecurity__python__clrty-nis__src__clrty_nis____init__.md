...
// Migrated from python/cybersecurity/python/clrty-nis/src/clrty_nis/__init__.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module PythonCybersecurityPythonClrtyNisSrcClrtyNisInit {

  embed gates 3..=6 {
    context: "MIS cutover of python/cybersecurity/python/clrty-nis/src/clrty_nis/__init__.py on clrty-1";
