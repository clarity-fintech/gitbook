# `moniversive/migrated/scripts/clarity_docs/sync_notion.mis`

> Generated 2026-07-26T17:14:13Z · module **`ScriptsClarityDocsSyncNotion`** · 30 lines

```bash
bin/misc moniversive/migrated/scripts/clarity_docs/sync_notion.mis --check --compact-letters
```
...
// Migrated from scripts/clarity_docs/sync_notion.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsClarityDocsSyncNotion {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/clarity_docs/sync_notion.py on clrty-1";
