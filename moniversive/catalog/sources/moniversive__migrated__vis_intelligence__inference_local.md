...
// Migrated from vis_intelligence/inference_local.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module VisIntelligenceInferenceLocal {

  embed gates 3..=6 {
    context: "MIS cutover of vis_intelligence/inference_local.py on clrty-1";
