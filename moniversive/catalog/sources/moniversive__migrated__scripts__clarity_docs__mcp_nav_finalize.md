# `moniversive/migrated/scripts/clarity_docs/mcp_nav_finalize.mis`

> Generated 2026-07-26T17:24:53Z · module **`ScriptsClarityDocsMcpNavFinalize`** · 30 lines

```bash
bin/misc moniversive/migrated/scripts/clarity_docs/mcp_nav_finalize.mis --check --compact-letters
```
...
// Migrated from scripts/clarity_docs/mcp_nav_finalize.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsClarityDocsMcpNavFinalize {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/clarity_docs/mcp_nav_finalize.py on clrty-1";
