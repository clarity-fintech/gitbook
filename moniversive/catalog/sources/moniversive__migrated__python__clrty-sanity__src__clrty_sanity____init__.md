# `moniversive/migrated/python/clrty-sanity/src/clrty_sanity/__init__.mis`

> Generated 2026-07-26T17:24:53Z · module **`PythonClrtySanitySrcClrtySanityInit`** · 30 lines

```bash
bin/misc moniversive/migrated/python/clrty-sanity/src/clrty_sanity/__init__.mis --check --compact-letters
```
...
// Migrated from python/clrty-sanity/src/clrty_sanity/__init__.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module PythonClrtySanitySrcClrtySanityInit {

  embed gates 3..=6 {
    context: "MIS cutover of python/clrty-sanity/src/clrty_sanity/__init__.py on clrty-1";
