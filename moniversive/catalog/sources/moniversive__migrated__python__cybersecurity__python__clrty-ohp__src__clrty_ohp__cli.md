# `moniversive/migrated/python/cybersecurity/python/clrty-ohp/src/clrty_ohp/cli.mis`

> Generated 2026-07-26T17:24:53Z · module **`PythonCybersecurityPythonClrtyOhpSrcClrtyOhpCli`** · 30 lines

```bash
bin/misc moniversive/migrated/python/cybersecurity/python/clrty-ohp/src/clrty_ohp/cli.mis --check --compact-letters
```
...
// Migrated from python/cybersecurity/python/clrty-ohp/src/clrty_ohp/cli.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module PythonCybersecurityPythonClrtyOhpSrcClrtyOhpCli {

  embed gates 3..=6 {
    context: "MIS cutover of python/cybersecurity/python/clrty-ohp/src/clrty_ohp/cli.py on clrty-1";
