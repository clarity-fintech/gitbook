# `moniversive/migrated/scripts/clrtynet/generate_bridge_nano.mis`

> Generated 2026-07-26T17:14:13Z · module **`ScriptsClrtynetGenerateBridgeNano`** · 30 lines

```bash
bin/misc moniversive/migrated/scripts/clrtynet/generate_bridge_nano.mis --check --compact-letters
```
...
// Migrated from scripts/clrtynet/generate_bridge_nano.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsClrtynetGenerateBridgeNano {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/clrtynet/generate_bridge_nano.py on clrty-1";
