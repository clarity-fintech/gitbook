# `moniversive/migrated/python/clrty-hud/src/clrty_hud/cli.mis`

> Generated 2026-07-26T17:24:53Z · module **`PythonClrtyHudSrcClrtyHudCli`** · 30 lines

```bash
bin/misc moniversive/migrated/python/clrty-hud/src/clrty_hud/cli.mis --check --compact-letters
```
...
// Migrated from python/clrty-hud/src/clrty_hud/cli.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module PythonClrtyHudSrcClrtyHudCli {

  embed gates 3..=6 {
    context: "MIS cutover of python/clrty-hud/src/clrty_hud/cli.py on clrty-1";
