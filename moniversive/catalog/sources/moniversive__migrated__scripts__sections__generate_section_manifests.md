# `moniversive/migrated/scripts/sections/generate_section_manifests.mis`

> Generated 2026-07-26T17:14:13Z · module **`ScriptsSectionsGenerateSectionManifests`** · 30 lines

```bash
bin/misc moniversive/migrated/scripts/sections/generate_section_manifests.mis --check --compact-letters
```
...
// Migrated from scripts/sections/generate_section_manifests.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsSectionsGenerateSectionManifests {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/sections/generate_section_manifests.py on clrty-1";
