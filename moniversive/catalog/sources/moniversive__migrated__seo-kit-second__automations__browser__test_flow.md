# `moniversive/migrated/seo-kit-second/automations/browser/test_flow.mis`

> Generated 2026-07-26T17:14:13Z · module **`SeoKitSecondAutomationsBrowserTestFlow`** · 30 lines

```bash
bin/misc moniversive/migrated/seo-kit-second/automations/browser/test_flow.mis --check --compact-letters
```
...
// Migrated from seo-kit-second/automations/browser/test_flow.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module SeoKitSecondAutomationsBrowserTestFlow {

  embed gates 3..=6 {
    context: "MIS cutover of seo-kit-second/automations/browser/test_flow.py on clrty-1";
