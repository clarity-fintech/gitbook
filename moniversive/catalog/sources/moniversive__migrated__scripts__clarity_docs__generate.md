# `moniversive/migrated/scripts/clarity_docs/generate.mis`

> Generated 2026-07-26T17:14:13Z · module **`ScriptsClarityDocsGenerate`** · 30 lines

```bash
bin/misc moniversive/migrated/scripts/clarity_docs/generate.mis --check --compact-letters
```
...
// Migrated from scripts/clarity_docs/generate.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsClarityDocsGenerate {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/clarity_docs/generate.py on clrty-1";
