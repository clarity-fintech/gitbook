# `moniversive/migrated/scripts/launch/build_launch_tasks_snapshot.mis`

> Generated 2026-07-26T17:14:13Z · module **`ScriptsLaunchBuildLaunchTasksSnapshot`** · 30 lines

```bash
bin/misc moniversive/migrated/scripts/launch/build_launch_tasks_snapshot.mis --check --compact-letters
```
...
// Migrated from scripts/launch/build_launch_tasks_snapshot.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsLaunchBuildLaunchTasksSnapshot {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/launch/build_launch_tasks_snapshot.py on clrty-1";
