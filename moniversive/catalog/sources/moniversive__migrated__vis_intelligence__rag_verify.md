# `moniversive/migrated/vis_intelligence/rag_verify.mis`

> Generated 2026-07-26T17:24:54Z · module **`VisIntelligenceRagVerify`** · 30 lines

```bash
bin/misc moniversive/migrated/vis_intelligence/rag_verify.mis --check --compact-letters
```
...
// Migrated from vis_intelligence/rag_verify.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module VisIntelligenceRagVerify {

  embed gates 3..=6 {
    context: "MIS cutover of vis_intelligence/rag_verify.py on clrty-1";
