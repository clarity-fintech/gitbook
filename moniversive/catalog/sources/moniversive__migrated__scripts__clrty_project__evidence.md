# `moniversive/migrated/scripts/clrty_project/evidence.mis`

> Generated 2026-07-26T17:24:53Z · module **`ScriptsClrtyProjectEvidence`** · 30 lines

```bash
bin/misc moniversive/migrated/scripts/clrty_project/evidence.mis --check --compact-letters
```
...
// Migrated from scripts/clrty_project/evidence.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsClrtyProjectEvidence {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/clrty_project/evidence.py on clrty-1";
