...
// Migrated from scripts/clrtynet/generate_browser_nano.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsClrtynetGenerateBrowserNano {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/clrtynet/generate_browser_nano.py on clrty-1";
