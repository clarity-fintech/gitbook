# `moniversive/migrated/python/clrty-site/src/clrty_site/sync.mis`

> Generated 2026-07-26T17:24:53Z · module **`PythonClrtySiteSrcClrtySiteSync`** · 30 lines

```bash
bin/misc moniversive/migrated/python/clrty-site/src/clrty_site/sync.mis --check --compact-letters
```
...
// Migrated from python/clrty-site/src/clrty_site/sync.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module PythonClrtySiteSrcClrtySiteSync {

  embed gates 3..=6 {
    context: "MIS cutover of python/clrty-site/src/clrty_site/sync.py on clrty-1";
