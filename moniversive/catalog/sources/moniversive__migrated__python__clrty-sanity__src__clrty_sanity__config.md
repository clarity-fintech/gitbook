# `moniversive/migrated/python/clrty-sanity/src/clrty_sanity/config.mis`

> Generated 2026-07-26T17:14:13Z · module **`PythonClrtySanitySrcClrtySanityConfig`** · 30 lines

```bash
bin/misc moniversive/migrated/python/clrty-sanity/src/clrty_sanity/config.mis --check --compact-letters
```
...
// Migrated from python/clrty-sanity/src/clrty_sanity/config.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module PythonClrtySanitySrcClrtySanityConfig {

  embed gates 3..=6 {
    context: "MIS cutover of python/clrty-sanity/src/clrty_sanity/config.py on clrty-1";
