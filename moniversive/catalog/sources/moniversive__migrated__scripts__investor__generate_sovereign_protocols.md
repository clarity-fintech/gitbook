...
// Migrated from scripts/investor/generate_sovereign_protocols.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsInvestorGenerateSovereignProtocols {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/investor/generate_sovereign_protocols.py on clrty-1";
