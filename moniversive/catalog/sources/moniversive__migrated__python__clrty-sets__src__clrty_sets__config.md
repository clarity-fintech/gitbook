# `moniversive/migrated/python/clrty-sets/src/clrty_sets/config.mis`

> Generated 2026-07-26T17:24:53Z · module **`PythonClrtySetsSrcClrtySetsConfig`** · 30 lines

```bash
bin/misc moniversive/migrated/python/clrty-sets/src/clrty_sets/config.mis --check --compact-letters
```
...
// Migrated from python/clrty-sets/src/clrty_sets/config.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module PythonClrtySetsSrcClrtySetsConfig {

  embed gates 3..=6 {
    context: "MIS cutover of python/clrty-sets/src/clrty_sets/config.py on clrty-1";
