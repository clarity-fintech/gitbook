...
// Migrated from scripts/fellowship/validate_submission.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsFellowshipValidateSubmission {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/fellowship/validate_submission.py on clrty-1";
