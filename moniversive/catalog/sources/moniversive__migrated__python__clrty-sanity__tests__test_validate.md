# `moniversive/migrated/python/clrty-sanity/tests/test_validate.mis`

> Generated 2026-07-26T17:24:53Z · module **`PythonClrtySanityTestsTestValidate`** · 30 lines

```bash
bin/misc moniversive/migrated/python/clrty-sanity/tests/test_validate.mis --check --compact-letters
```
...
// Migrated from python/clrty-sanity/tests/test_validate.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module PythonClrtySanityTestsTestValidate {

  embed gates 3..=6 {
    context: "MIS cutover of python/clrty-sanity/tests/test_validate.py on clrty-1";
