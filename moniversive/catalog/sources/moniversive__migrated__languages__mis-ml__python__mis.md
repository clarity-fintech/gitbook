...
// Migrated from languages/mis-ml/python/mis.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module LanguagesMisMlPythonMis {

  embed gates 3..=6 {
    context: "MIS cutover of languages/mis-ml/python/mis.py on clrty-1";
