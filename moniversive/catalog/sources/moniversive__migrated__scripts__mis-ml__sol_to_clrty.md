...
// Migrated from scripts/mis-ml/sol_to_clrty.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsMisMlSolToClrty {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/mis-ml/sol_to_clrty.py on clrty-1";
