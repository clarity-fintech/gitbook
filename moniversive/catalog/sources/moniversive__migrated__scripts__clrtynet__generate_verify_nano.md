# `moniversive/migrated/scripts/clrtynet/generate_verify_nano.mis`

> Generated 2026-07-26T17:24:53Z · module **`ScriptsClrtynetGenerateVerifyNano`** · 30 lines

```bash
bin/misc moniversive/migrated/scripts/clrtynet/generate_verify_nano.mis --check --compact-letters
```
...
// Migrated from scripts/clrtynet/generate_verify_nano.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsClrtynetGenerateVerifyNano {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/clrtynet/generate_verify_nano.py on clrty-1";
