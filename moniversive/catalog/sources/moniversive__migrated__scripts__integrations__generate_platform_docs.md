# `moniversive/migrated/scripts/integrations/generate_platform_docs.mis`

> Generated 2026-07-26T17:14:13Z · module **`ScriptsIntegrationsGeneratePlatformDocs`** · 30 lines

```bash
bin/misc moniversive/migrated/scripts/integrations/generate_platform_docs.mis --check --compact-letters
```
...
// Migrated from scripts/integrations/generate_platform_docs.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsIntegrationsGeneratePlatformDocs {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/integrations/generate_platform_docs.py on clrty-1";
