...
// Migrated from python/clrty-hud/src/clrty_hud/radial.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module PythonClrtyHudSrcClrtyHudRadial {

  embed gates 3..=6 {
    context: "MIS cutover of python/clrty-hud/src/clrty_hud/radial.py on clrty-1";
