# `moniversive/migrated/scripts/clarity_docs/operator_pack.mis`

> Generated 2026-07-26T17:24:53Z · module **`ScriptsClarityDocsOperatorPack`** · 30 lines

```bash
bin/misc moniversive/migrated/scripts/clarity_docs/operator_pack.mis --check --compact-letters
```
...
// Migrated from scripts/clarity_docs/operator_pack.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsClarityDocsOperatorPack {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/clarity_docs/operator_pack.py on clrty-1";
