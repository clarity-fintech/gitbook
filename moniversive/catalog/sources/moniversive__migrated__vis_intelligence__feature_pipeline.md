...
// Migrated from vis_intelligence/feature_pipeline.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module VisIntelligenceFeaturePipeline {

  embed gates 3..=6 {
    context: "MIS cutover of vis_intelligence/feature_pipeline.py on clrty-1";
