# `moniversive/migrated/scripts/clarity_docs/bulk_nav_sync_progress.mis`

> Generated 2026-07-26T17:24:53Z · module **`ScriptsClarityDocsBulkNavSyncProgress`** · 30 lines

```bash
bin/misc moniversive/migrated/scripts/clarity_docs/bulk_nav_sync_progress.mis --check --compact-letters
```
...
// Migrated from scripts/clarity_docs/bulk_nav_sync_progress.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsClarityDocsBulkNavSyncProgress {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/clarity_docs/bulk_nav_sync_progress.py on clrty-1";
