# `moniversive/migrated/scripts/clarity_docs/content.mis`

> Generated 2026-07-26T17:24:53Z · module **`ScriptsClarityDocsContent`** · 30 lines

```bash
bin/misc moniversive/migrated/scripts/clarity_docs/content.mis --check --compact-letters
```
...
// Migrated from scripts/clarity_docs/content.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsClarityDocsContent {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/clarity_docs/content.py on clrty-1";
