...
// Migrated from scripts/clrty_project/security.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsClrtyProjectSecurity {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/clrty_project/security.py on clrty-1";
