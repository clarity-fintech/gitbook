# `moniversive/migrated/scripts/integrations/generate_platform_manifest.mis`

> Generated 2026-07-26T17:24:53Z · module **`ScriptsIntegrationsGeneratePlatformManifest`** · 30 lines

```bash
bin/misc moniversive/migrated/scripts/integrations/generate_platform_manifest.mis --check --compact-letters
```
...
// Migrated from scripts/integrations/generate_platform_manifest.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsIntegrationsGeneratePlatformManifest {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/integrations/generate_platform_manifest.py on clrty-1";
