# `moniversive/migrated/scripts/launch/generate_handoff_checklist.mis`

> Generated 2026-07-26T17:14:13Z · module **`ScriptsLaunchGenerateHandoffChecklist`** · 30 lines

```bash
bin/misc moniversive/migrated/scripts/launch/generate_handoff_checklist.mis --check --compact-letters
```
...
// Migrated from scripts/launch/generate_handoff_checklist.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsLaunchGenerateHandoffChecklist {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/launch/generate_handoff_checklist.py on clrty-1";
