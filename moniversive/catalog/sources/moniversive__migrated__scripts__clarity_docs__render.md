# `moniversive/migrated/scripts/clarity_docs/render.mis`

> Generated 2026-07-26T17:24:53Z · module **`ScriptsClarityDocsRender`** · 30 lines

```bash
bin/misc moniversive/migrated/scripts/clarity_docs/render.mis --check --compact-letters
```
...
// Migrated from scripts/clarity_docs/render.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsClarityDocsRender {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/clarity_docs/render.py on clrty-1";
