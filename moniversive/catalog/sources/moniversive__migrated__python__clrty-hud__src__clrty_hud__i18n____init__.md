# `moniversive/migrated/python/clrty-hud/src/clrty_hud/i18n/__init__.mis`

> Generated 2026-07-26T17:24:53Z · module **`PythonClrtyHudSrcClrtyHudI18nInit`** · 30 lines

```bash
bin/misc moniversive/migrated/python/clrty-hud/src/clrty_hud/i18n/__init__.mis --check --compact-letters
```
...
// Migrated from python/clrty-hud/src/clrty_hud/i18n/__init__.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module PythonClrtyHudSrcClrtyHudI18nInit {

  embed gates 3..=6 {
    context: "MIS cutover of python/clrty-hud/src/clrty_hud/i18n/__init__.py on clrty-1";
