# `moniversive/migrated/python/clrty-gss/src/clrty_gss/config.mis`

> Generated 2026-07-26T17:24:53Z · module **`PythonClrtyGssSrcClrtyGssConfig`** · 30 lines

```bash
bin/misc moniversive/migrated/python/clrty-gss/src/clrty_gss/config.mis --check --compact-letters
```
...
// Migrated from python/clrty-gss/src/clrty_gss/config.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module PythonClrtyGssSrcClrtyGssConfig {

  embed gates 3..=6 {
    context: "MIS cutover of python/clrty-gss/src/clrty_gss/config.py on clrty-1";
