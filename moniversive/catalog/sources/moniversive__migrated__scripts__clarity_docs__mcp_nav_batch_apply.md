# `moniversive/migrated/scripts/clarity_docs/mcp_nav_batch_apply.mis`

> Generated 2026-07-26T17:24:53Z · module **`ScriptsClarityDocsMcpNavBatchApply`** · 30 lines

```bash
bin/misc moniversive/migrated/scripts/clarity_docs/mcp_nav_batch_apply.mis --check --compact-letters
```
...
// Migrated from scripts/clarity_docs/mcp_nav_batch_apply.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsClarityDocsMcpNavBatchApply {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/clarity_docs/mcp_nav_batch_apply.py on clrty-1";
