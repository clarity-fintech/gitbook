# `moniversive/migrated/scripts/clrty_project/networks.mis`

> Generated 2026-07-26T17:14:13Z · module **`ScriptsClrtyProjectNetworks`** · 30 lines

```bash
bin/misc moniversive/migrated/scripts/clrty_project/networks.mis --check --compact-letters
```
...
// Migrated from scripts/clrty_project/networks.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsClrtyProjectNetworks {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/clrty_project/networks.py on clrty-1";
