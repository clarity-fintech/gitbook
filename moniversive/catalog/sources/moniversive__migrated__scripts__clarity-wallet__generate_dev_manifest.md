# `moniversive/migrated/scripts/clarity-wallet/generate_dev_manifest.mis`

> Generated 2026-07-26T17:14:13Z · module **`ScriptsClarityWalletGenerateDevManifest`** · 30 lines

```bash
bin/misc moniversive/migrated/scripts/clarity-wallet/generate_dev_manifest.mis --check --compact-letters
```
...
// Migrated from scripts/clarity-wallet/generate_dev_manifest.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsClarityWalletGenerateDevManifest {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/clarity-wallet/generate_dev_manifest.py on clrty-1";
