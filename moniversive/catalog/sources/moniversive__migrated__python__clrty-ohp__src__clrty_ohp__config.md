# `moniversive/migrated/python/clrty-ohp/src/clrty_ohp/config.mis`

> Generated 2026-07-26T17:24:53Z · module **`PythonClrtyOhpSrcClrtyOhpConfig`** · 30 lines

```bash
bin/misc moniversive/migrated/python/clrty-ohp/src/clrty_ohp/config.mis --check --compact-letters
```
...
// Migrated from python/clrty-ohp/src/clrty_ohp/config.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module PythonClrtyOhpSrcClrtyOhpConfig {

  embed gates 3..=6 {
    context: "MIS cutover of python/clrty-ohp/src/clrty_ohp/config.py on clrty-1";
