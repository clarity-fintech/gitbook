# `moniversive/migrated/scripts/mis-ml/verify_mis_code_index.mis`

> Generated 2026-07-26T17:14:13Z · module **`ScriptsMisMlVerifyMisCodeIndex`** · 30 lines

```bash
bin/misc moniversive/migrated/scripts/mis-ml/verify_mis_code_index.mis --check --compact-letters
```
...
// Migrated from scripts/mis-ml/verify_mis_code_index.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsMisMlVerifyMisCodeIndex {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/mis-ml/verify_mis_code_index.py on clrty-1";
