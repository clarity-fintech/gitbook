# `moniversive/migrated/scripts/clarity_docs/gs_core_pack.mis`

> Generated 2026-07-26T17:14:13Z · module **`ScriptsClarityDocsGsCorePack`** · 30 lines

```bash
bin/misc moniversive/migrated/scripts/clarity_docs/gs_core_pack.mis --check --compact-letters
```
...
// Migrated from scripts/clarity_docs/gs_core_pack.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsClarityDocsGsCorePack {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/clarity_docs/gs_core_pack.py on clrty-1";
