...
// Migrated from scripts/website/expand_content_manifest.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsWebsiteExpandContentManifest {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/website/expand_content_manifest.py on clrty-1";
