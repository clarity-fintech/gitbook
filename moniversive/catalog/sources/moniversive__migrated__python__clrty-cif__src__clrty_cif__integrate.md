# `moniversive/migrated/python/clrty-cif/src/clrty_cif/integrate.mis`

> Generated 2026-07-26T17:24:53Z · module **`PythonClrtyCifSrcClrtyCifIntegrate`** · 30 lines

```bash
bin/misc moniversive/migrated/python/clrty-cif/src/clrty_cif/integrate.mis --check --compact-letters
```
...
// Migrated from python/clrty-cif/src/clrty_cif/integrate.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module PythonClrtyCifSrcClrtyCifIntegrate {

  embed gates 3..=6 {
    context: "MIS cutover of python/clrty-cif/src/clrty_cif/integrate.py on clrty-1";
