# `moniversive/migrated/scripts/products/generate_product_pages.mis`

> Generated 2026-07-26T17:24:53Z · module **`ScriptsProductsGenerateProductPages`** · 30 lines

```bash
bin/misc moniversive/migrated/scripts/products/generate_product_pages.mis --check --compact-letters
```
...
// Migrated from scripts/products/generate_product_pages.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsProductsGenerateProductPages {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/products/generate_product_pages.py on clrty-1";
