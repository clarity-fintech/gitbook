# `moniversive/migrated/python/clrty-sanity/src/clrty_sanity/cli.mis`

> Generated 2026-07-26T17:14:13Z · module **`PythonClrtySanitySrcClrtySanityCli`** · 30 lines

```bash
bin/misc moniversive/migrated/python/clrty-sanity/src/clrty_sanity/cli.mis --check --compact-letters
```
...
// Migrated from python/clrty-sanity/src/clrty_sanity/cli.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module PythonClrtySanitySrcClrtySanityCli {

  embed gates 3..=6 {
    context: "MIS cutover of python/clrty-sanity/src/clrty_sanity/cli.py on clrty-1";
