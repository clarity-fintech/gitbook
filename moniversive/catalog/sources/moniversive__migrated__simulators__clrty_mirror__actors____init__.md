# `moniversive/migrated/simulators/clrty_mirror/actors/__init__.mis`

> Generated 2026-07-26T17:14:13Z · module **`SimulatorsClrtyMirrorActorsInit`** · 30 lines

```bash
bin/misc moniversive/migrated/simulators/clrty_mirror/actors/__init__.mis --check --compact-letters
```
...
// Migrated from simulators/clrty_mirror/actors/__init__.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module SimulatorsClrtyMirrorActorsInit {

  embed gates 3..=6 {
    context: "MIS cutover of simulators/clrty_mirror/actors/__init__.py on clrty-1";
