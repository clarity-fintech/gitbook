# `moniversive/migrated/scripts/clrty_project/__init__.mis`

> Generated 2026-07-26T17:14:13Z · module **`ScriptsClrtyProjectInit`** · 30 lines

```bash
bin/misc moniversive/migrated/scripts/clrty_project/__init__.mis --check --compact-letters
```
...
// Migrated from scripts/clrty_project/__init__.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsClrtyProjectInit {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/clrty_project/__init__.py on clrty-1";
