# `moniversive/migrated/scripts/clarity_docs/chain.mis`

> Generated 2026-07-26T17:14:13Z · module **`ScriptsClarityDocsChain`** · 30 lines

```bash
bin/misc moniversive/migrated/scripts/clarity_docs/chain.mis --check --compact-letters
```
...
// Migrated from scripts/clarity_docs/chain.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsClarityDocsChain {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/clarity_docs/chain.py on clrty-1";
