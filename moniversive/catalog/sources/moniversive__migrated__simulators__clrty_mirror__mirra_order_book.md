# `moniversive/migrated/simulators/clrty_mirror/mirra_order_book.mis`

> Generated 2026-07-26T17:14:13Z · module **`SimulatorsClrtyMirrorMirraOrderBook`** · 30 lines

```bash
bin/misc moniversive/migrated/simulators/clrty_mirror/mirra_order_book.mis --check --compact-letters
```
...
// Migrated from simulators/clrty_mirror/mirra_order_book.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module SimulatorsClrtyMirrorMirraOrderBook {

  embed gates 3..=6 {
    context: "MIS cutover of simulators/clrty_mirror/mirra_order_book.py on clrty-1";
