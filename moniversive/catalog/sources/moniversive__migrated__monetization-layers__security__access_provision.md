# `moniversive/migrated/monetization-layers/security/access_provision.mis`

> Generated 2026-07-26T17:14:13Z · module **`MonetizationLayersSecurityAccessProvision`** · 30 lines

```bash
bin/misc moniversive/migrated/monetization-layers/security/access_provision.mis --check --compact-letters
```
...
// Migrated from monetization-layers/security/access_provision.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module MonetizationLayersSecurityAccessProvision {

  embed gates 3..=6 {
    context: "MIS cutover of monetization-layers/security/access_provision.py on clrty-1";
