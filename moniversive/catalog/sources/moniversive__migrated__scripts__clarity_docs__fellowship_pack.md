# `moniversive/migrated/scripts/clarity_docs/fellowship_pack.mis`

> Generated 2026-07-26T17:24:53Z · module **`ScriptsClarityDocsFellowshipPack`** · 30 lines

```bash
bin/misc moniversive/migrated/scripts/clarity_docs/fellowship_pack.mis --check --compact-letters
```
...
// Migrated from scripts/clarity_docs/fellowship_pack.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsClarityDocsFellowshipPack {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/clarity_docs/fellowship_pack.py on clrty-1";
