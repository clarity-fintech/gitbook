...
// Migrated from python/clrty-site/src/clrty_site/config.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module PythonClrtySiteSrcClrtySiteConfig {

  embed gates 3..=6 {
    context: "MIS cutover of python/clrty-site/src/clrty_site/config.py on clrty-1";
