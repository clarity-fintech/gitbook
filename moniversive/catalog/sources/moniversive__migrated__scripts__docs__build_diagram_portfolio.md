# `moniversive/migrated/scripts/docs/build_diagram_portfolio.mis`

> Generated 2026-07-26T17:14:13Z · module **`ScriptsDocsBuildDiagramPortfolio`** · 30 lines

```bash
bin/misc moniversive/migrated/scripts/docs/build_diagram_portfolio.mis --check --compact-letters
```
...
// Migrated from scripts/docs/build_diagram_portfolio.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsDocsBuildDiagramPortfolio {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/docs/build_diagram_portfolio.py on clrty-1";
