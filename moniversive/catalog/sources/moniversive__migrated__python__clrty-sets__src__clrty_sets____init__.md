# `moniversive/migrated/python/clrty-sets/src/clrty_sets/__init__.mis`

> Generated 2026-07-26T17:24:53Z · module **`PythonClrtySetsSrcClrtySetsInit`** · 30 lines

```bash
bin/misc moniversive/migrated/python/clrty-sets/src/clrty_sets/__init__.mis --check --compact-letters
```
...
// Migrated from python/clrty-sets/src/clrty_sets/__init__.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module PythonClrtySetsSrcClrtySetsInit {

  embed gates 3..=6 {
    context: "MIS cutover of python/clrty-sets/src/clrty_sets/__init__.py on clrty-1";
