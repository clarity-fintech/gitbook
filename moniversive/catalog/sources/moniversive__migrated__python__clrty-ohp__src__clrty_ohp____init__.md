# `moniversive/migrated/python/clrty-ohp/src/clrty_ohp/__init__.mis`

> Generated 2026-07-26T17:14:13Z · module **`PythonClrtyOhpSrcClrtyOhpInit`** · 30 lines

```bash
bin/misc moniversive/migrated/python/clrty-ohp/src/clrty_ohp/__init__.mis --check --compact-letters
```
...
// Migrated from python/clrty-ohp/src/clrty_ohp/__init__.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module PythonClrtyOhpSrcClrtyOhpInit {

  embed gates 3..=6 {
    context: "MIS cutover of python/clrty-ohp/src/clrty_ohp/__init__.py on clrty-1";
