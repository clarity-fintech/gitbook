...
// Migrated from simulators/tokenomics/simulate.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module SimulatorsTokenomicsSimulate {

  embed gates 3..=6 {
    context: "MIS cutover of simulators/tokenomics/simulate.py on clrty-1";
