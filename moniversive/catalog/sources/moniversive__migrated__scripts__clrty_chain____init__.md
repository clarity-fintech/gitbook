# `moniversive/migrated/scripts/clrty_chain/__init__.mis`

> Generated 2026-07-26T17:14:13Z · module **`ScriptsClrtyChainInit`** · 30 lines

```bash
bin/misc moniversive/migrated/scripts/clrty_chain/__init__.mis --check --compact-letters
```
...
// Migrated from scripts/clrty_chain/__init__.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsClrtyChainInit {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/clrty_chain/__init__.py on clrty-1";
