# `moniversive/migrated/scripts/metrics/sync_sheets_inputs.mis`

> Generated 2026-07-26T17:24:53Z · module **`ScriptsMetricsSyncSheetsInputs`** · 30 lines

```bash
bin/misc moniversive/migrated/scripts/metrics/sync_sheets_inputs.mis --check --compact-letters
```
...
// Migrated from scripts/metrics/sync_sheets_inputs.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsMetricsSyncSheetsInputs {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/metrics/sync_sheets_inputs.py on clrty-1";
