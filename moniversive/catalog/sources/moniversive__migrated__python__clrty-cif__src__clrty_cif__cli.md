...
// Migrated from python/clrty-cif/src/clrty_cif/cli.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module PythonClrtyCifSrcClrtyCifCli {

  embed gates 3..=6 {
    context: "MIS cutover of python/clrty-cif/src/clrty_cif/cli.py on clrty-1";
