...
// Migrated from simulators/clrty_mirror/actors/panic.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module SimulatorsClrtyMirrorActorsPanic {

  embed gates 3..=6 {
    context: "MIS cutover of simulators/clrty_mirror/actors/panic.py on clrty-1";
