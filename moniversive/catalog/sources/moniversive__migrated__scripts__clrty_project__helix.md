# `moniversive/migrated/scripts/clrty_project/helix.mis`

> Generated 2026-07-26T17:14:13Z · module **`ScriptsClrtyProjectHelix`** · 30 lines

```bash
bin/misc moniversive/migrated/scripts/clrty_project/helix.mis --check --compact-letters
```
...
// Migrated from scripts/clrty_project/helix.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsClrtyProjectHelix {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/clrty_project/helix.py on clrty-1";
