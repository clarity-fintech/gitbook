...
// Migrated from seo-kit-second/automations/browser_publish.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module SeoKitSecondAutomationsBrowserPublish {

  embed gates 3..=6 {
    context: "MIS cutover of seo-kit-second/automations/browser_publish.py on clrty-1";
