# `moniversive/migrated/scripts/clarity_docs/notion_markdown.mis`

> Generated 2026-07-26T17:14:13Z · module **`ScriptsClarityDocsNotionMarkdown`** · 30 lines

```bash
bin/misc moniversive/migrated/scripts/clarity_docs/notion_markdown.mis --check --compact-letters
```
...
// Migrated from scripts/clarity_docs/notion_markdown.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsClarityDocsNotionMarkdown {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/clarity_docs/notion_markdown.py on clrty-1";
