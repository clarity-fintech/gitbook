# `moniversive/migrated/scripts/framer/generate_sitemap.mis`

> Generated 2026-07-26T17:14:13Z · module **`ScriptsFramerGenerateSitemap`** · 30 lines

```bash
bin/misc moniversive/migrated/scripts/framer/generate_sitemap.mis --check --compact-letters
```
...
// Migrated from scripts/framer/generate_sitemap.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsFramerGenerateSitemap {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/framer/generate_sitemap.py on clrty-1";
