# `moniversive/migrated/scripts/website/enrich_program_pages.mis`

> Generated 2026-07-26T17:14:13Z · module **`ScriptsWebsiteEnrichProgramPages`** · 30 lines

```bash
bin/misc moniversive/migrated/scripts/website/enrich_program_pages.mis --check --compact-letters
```
...
// Migrated from scripts/website/enrich_program_pages.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsWebsiteEnrichProgramPages {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/website/enrich_program_pages.py on clrty-1";
