# `moniversive/migrated/simulators/clrty_mirror/run_batch.mis`

> Generated 2026-07-26T17:24:53Z · module **`SimulatorsClrtyMirrorRunBatch`** · 30 lines

```bash
bin/misc moniversive/migrated/simulators/clrty_mirror/run_batch.mis --check --compact-letters
```
...
// Migrated from simulators/clrty_mirror/run_batch.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module SimulatorsClrtyMirrorRunBatch {

  embed gates 3..=6 {
    context: "MIS cutover of simulators/clrty_mirror/run_batch.py on clrty-1";
