# `moniversive/migrated/scripts/clarity_docs/manifests.mis`

> Generated 2026-07-26T17:14:13Z · module **`ScriptsClarityDocsManifests`** · 30 lines

```bash
bin/misc moniversive/migrated/scripts/clarity_docs/manifests.mis --check --compact-letters
```
...
// Migrated from scripts/clarity_docs/manifests.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsClarityDocsManifests {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/clarity_docs/manifests.py on clrty-1";
