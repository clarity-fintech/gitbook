...
// Migrated from scripts/clarity_docs/mcp_nav_batch_mark.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsClarityDocsMcpNavBatchMark {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/clarity_docs/mcp_nav_batch_mark.py on clrty-1";
