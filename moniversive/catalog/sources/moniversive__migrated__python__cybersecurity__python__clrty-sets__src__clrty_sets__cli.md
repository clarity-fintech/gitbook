...
// Migrated from python/cybersecurity/python/clrty-sets/src/clrty_sets/cli.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module PythonCybersecurityPythonClrtySetsSrcClrtySetsCli {

  embed gates 3..=6 {
    context: "MIS cutover of python/cybersecurity/python/clrty-sets/src/clrty_sets/cli.py on clrty-1";
