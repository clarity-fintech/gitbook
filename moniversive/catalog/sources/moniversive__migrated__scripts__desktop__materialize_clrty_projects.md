...
// Migrated from scripts/desktop/materialize_clrty_projects.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsDesktopMaterializeClrtyProjects {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/desktop/materialize_clrty_projects.py on clrty-1";
