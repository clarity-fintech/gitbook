# `moniversive/migrated/scripts/clrty_project/ops_surface.mis`

> Generated 2026-07-26T17:24:53Z · module **`ScriptsClrtyProjectOpsSurface`** · 30 lines

```bash
bin/misc moniversive/migrated/scripts/clrty_project/ops_surface.mis --check --compact-letters
```
...
// Migrated from scripts/clrty_project/ops_surface.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsClrtyProjectOpsSurface {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/clrty_project/ops_surface.py on clrty-1";
