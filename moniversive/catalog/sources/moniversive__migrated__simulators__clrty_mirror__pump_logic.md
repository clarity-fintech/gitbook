# `moniversive/migrated/simulators/clrty_mirror/pump_logic.mis`

> Generated 2026-07-26T17:24:53Z · module **`SimulatorsClrtyMirrorPumpLogic`** · 30 lines

```bash
bin/misc moniversive/migrated/simulators/clrty_mirror/pump_logic.mis --check --compact-letters
```
...
// Migrated from simulators/clrty_mirror/pump_logic.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module SimulatorsClrtyMirrorPumpLogic {

  embed gates 3..=6 {
    context: "MIS cutover of simulators/clrty_mirror/pump_logic.py on clrty-1";
