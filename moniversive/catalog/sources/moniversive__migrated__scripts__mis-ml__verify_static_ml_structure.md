...
// Migrated from scripts/mis-ml/verify_static_ml_structure.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsMisMlVerifyStaticMlStructure {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/mis-ml/verify_static_ml_structure.py on clrty-1";
