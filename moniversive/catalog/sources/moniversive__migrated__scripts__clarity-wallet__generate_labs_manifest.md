...
// Migrated from scripts/clarity-wallet/generate_labs_manifest.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsClarityWalletGenerateLabsManifest {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/clarity-wallet/generate_labs_manifest.py on clrty-1";
