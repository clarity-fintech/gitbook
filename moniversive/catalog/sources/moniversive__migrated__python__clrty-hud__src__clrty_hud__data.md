# `moniversive/migrated/python/clrty-hud/src/clrty_hud/data.mis`

> Generated 2026-07-26T17:14:13Z · module **`PythonClrtyHudSrcClrtyHudData`** · 30 lines

```bash
bin/misc moniversive/migrated/python/clrty-hud/src/clrty_hud/data.mis --check --compact-letters
```
...
// Migrated from python/clrty-hud/src/clrty_hud/data.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module PythonClrtyHudSrcClrtyHudData {

  embed gates 3..=6 {
    context: "MIS cutover of python/clrty-hud/src/clrty_hud/data.py on clrty-1";
