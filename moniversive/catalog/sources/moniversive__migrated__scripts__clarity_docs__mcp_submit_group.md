# `moniversive/migrated/scripts/clarity_docs/mcp_submit_group.mis`

> Generated 2026-07-26T17:24:53Z · module **`ScriptsClarityDocsMcpSubmitGroup`** · 30 lines

```bash
bin/misc moniversive/migrated/scripts/clarity_docs/mcp_submit_group.mis --check --compact-letters
```
...
// Migrated from scripts/clarity_docs/mcp_submit_group.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsClarityDocsMcpSubmitGroup {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/clarity_docs/mcp_submit_group.py on clrty-1";
