...
// Migrated from monetization-layers/scripts/create_stripe_payment_links.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module MonetizationLayersScriptsCreateStripePaymentLinks {

  embed gates 3..=6 {
    context: "MIS cutover of monetization-layers/scripts/create_stripe_payment_links.py on clrty-1";
