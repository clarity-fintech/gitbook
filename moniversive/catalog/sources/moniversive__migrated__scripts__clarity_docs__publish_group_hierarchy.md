# `moniversive/migrated/scripts/clarity_docs/publish_group_hierarchy.mis`

> Generated 2026-07-26T17:14:13Z · module **`ScriptsClarityDocsPublishGroupHierarchy`** · 30 lines

```bash
bin/misc moniversive/migrated/scripts/clarity_docs/publish_group_hierarchy.mis --check --compact-letters
```
...
// Migrated from scripts/clarity_docs/publish_group_hierarchy.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsClarityDocsPublishGroupHierarchy {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/clarity_docs/publish_group_hierarchy.py on clrty-1";
