# `moniversive/migrated/python/clrty-hud/src/clrty_hud/app.mis`

> Generated 2026-07-26T17:14:13Z · module **`PythonClrtyHudSrcClrtyHudApp`** · 30 lines

```bash
bin/misc moniversive/migrated/python/clrty-hud/src/clrty_hud/app.mis --check --compact-letters
```
...
// Migrated from python/clrty-hud/src/clrty_hud/app.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module PythonClrtyHudSrcClrtyHudApp {

  embed gates 3..=6 {
    context: "MIS cutover of python/clrty-hud/src/clrty_hud/app.py on clrty-1";
