# `moniversive/migrated/scripts/clrtynet/inventory_commands.mis`

> Generated 2026-07-26T17:14:13Z · module **`ScriptsClrtynetInventoryCommands`** · 30 lines

```bash
bin/misc moniversive/migrated/scripts/clrtynet/inventory_commands.mis --check --compact-letters
```
...
// Migrated from scripts/clrtynet/inventory_commands.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsClrtynetInventoryCommands {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/clrtynet/inventory_commands.py on clrty-1";
