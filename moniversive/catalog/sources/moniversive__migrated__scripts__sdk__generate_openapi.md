# `moniversive/migrated/scripts/sdk/generate_openapi.mis`

> Generated 2026-07-26T17:24:53Z · module **`ScriptsSdkGenerateOpenapi`** · 30 lines

```bash
bin/misc moniversive/migrated/scripts/sdk/generate_openapi.mis --check --compact-letters
```
...
// Migrated from scripts/sdk/generate_openapi.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsSdkGenerateOpenapi {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/sdk/generate_openapi.py on clrty-1";
