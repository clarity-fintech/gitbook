# `moniversive/migrated/scripts/clarity-wallet/generate_content_database.mis`

> Generated 2026-07-26T17:24:53Z · module **`ScriptsClarityWalletGenerateContentDatabase`** · 30 lines

```bash
bin/misc moniversive/migrated/scripts/clarity-wallet/generate_content_database.mis --check --compact-letters
```
...
// Migrated from scripts/clarity-wallet/generate_content_database.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsClarityWalletGenerateContentDatabase {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/clarity-wallet/generate_content_database.py on clrty-1";
