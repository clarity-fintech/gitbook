...
// Migrated from scripts/metrics/notion_client.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsMetricsNotionClient {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/metrics/notion_client.py on clrty-1";
