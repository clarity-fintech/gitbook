# `moniversive/migrated/languages/mis-ml/compiler/clrtyc.mis`

> Generated 2026-07-26T17:14:13Z · module **`LanguagesMisMlCompilerClrtyc`** · 30 lines

```bash
bin/misc moniversive/migrated/languages/mis-ml/compiler/clrtyc.mis --check --compact-letters
```
...
// Migrated from languages/mis-ml/compiler/clrtyc.py → .mis (CLRTY-1 MIS cutover)
// Kind: host_bootstrap

module LanguagesMisMlCompilerClrtyc {

  embed gates 3..=6 {
    context: "MIS cutover of languages/mis-ml/compiler/clrtyc.py on clrty-1";
