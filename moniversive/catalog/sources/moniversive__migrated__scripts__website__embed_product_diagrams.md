# `moniversive/migrated/scripts/website/embed_product_diagrams.mis`

> Generated 2026-07-26T17:24:53Z · module **`ScriptsWebsiteEmbedProductDiagrams`** · 30 lines

```bash
bin/misc moniversive/migrated/scripts/website/embed_product_diagrams.mis --check --compact-letters
```
...
// Migrated from scripts/website/embed_product_diagrams.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsWebsiteEmbedProductDiagrams {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/website/embed_product_diagrams.py on clrty-1";
