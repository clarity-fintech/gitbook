# `moniversive/migrated/docs/simulation/generate_charts.mis`

> Generated 2026-07-26T17:24:53Z · module **`DocsSimulationGenerateCharts`** · 30 lines

```bash
bin/misc moniversive/migrated/docs/simulation/generate_charts.mis --check --compact-letters
```
...
// Migrated from docs/simulation/generate_charts.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module DocsSimulationGenerateCharts {

  embed gates 3..=6 {
    context: "MIS cutover of docs/simulation/generate_charts.py on clrty-1";
