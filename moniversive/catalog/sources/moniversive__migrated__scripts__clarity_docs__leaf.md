# `moniversive/migrated/scripts/clarity_docs/leaf.mis`

> Generated 2026-07-26T17:24:53Z · module **`ScriptsClarityDocsLeaf`** · 30 lines

```bash
bin/misc moniversive/migrated/scripts/clarity_docs/leaf.mis --check --compact-letters
```
...
// Migrated from scripts/clarity_docs/leaf.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsClarityDocsLeaf {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/clarity_docs/leaf.py on clrty-1";
