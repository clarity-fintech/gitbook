...
// Migrated from scripts/mis-ml/moniversive_filter.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsMisMlMoniversiveFilter {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/mis-ml/moniversive_filter.py on clrty-1";
