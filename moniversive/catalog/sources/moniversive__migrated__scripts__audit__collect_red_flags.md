# `moniversive/migrated/scripts/audit/collect_red_flags.mis`

> Generated 2026-07-26T17:14:13Z · module **`ScriptsAuditCollectRedFlags`** · 30 lines

```bash
bin/misc moniversive/migrated/scripts/audit/collect_red_flags.mis --check --compact-letters
```
...
// Migrated from scripts/audit/collect_red_flags.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsAuditCollectRedFlags {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/audit/collect_red_flags.py on clrty-1";
