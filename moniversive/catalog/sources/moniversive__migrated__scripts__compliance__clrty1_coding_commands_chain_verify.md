...
// Migrated from scripts/compliance/clrty1_coding_commands_chain_verify.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsComplianceClrty1CodingCommandsChainVerify {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/compliance/clrty1_coding_commands_chain_verify.py on clrty-1";
