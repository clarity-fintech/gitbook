...
// Migrated from first_access_pack/02_terminal_vector/inference/bench_throughput.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module FirstAccessPack02TerminalVectorInferenceBenchThroughput {

  embed gates 3..=6 {
    context: "MIS cutover of first_access_pack/02_terminal_vector/inference/bench_throughput.py on clrty-1";
