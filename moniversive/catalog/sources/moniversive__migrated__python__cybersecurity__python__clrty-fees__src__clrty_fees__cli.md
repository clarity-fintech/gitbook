# `moniversive/migrated/python/cybersecurity/python/clrty-fees/src/clrty_fees/cli.mis`

> Generated 2026-07-26T17:14:13Z · module **`PythonCybersecurityPythonClrtyFeesSrcClrtyFeesCli`** · 30 lines

```bash
bin/misc moniversive/migrated/python/cybersecurity/python/clrty-fees/src/clrty_fees/cli.mis --check --compact-letters
```
...
// Migrated from python/cybersecurity/python/clrty-fees/src/clrty_fees/cli.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module PythonCybersecurityPythonClrtyFeesSrcClrtyFeesCli {

  embed gates 3..=6 {
    context: "MIS cutover of python/cybersecurity/python/clrty-fees/src/clrty_fees/cli.py on clrty-1";
