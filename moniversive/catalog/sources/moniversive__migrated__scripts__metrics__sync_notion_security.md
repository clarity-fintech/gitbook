...
// Migrated from scripts/metrics/sync_notion_security.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsMetricsSyncNotionSecurity {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/metrics/sync_notion_security.py on clrty-1";
