# `moniversive/packages/nanotasks/clarity.mis.nanotasks.clrty1_full_matrix_100.testnet.mis`

> Generated 2026-07-29T03:15:28Z · module **`clarity`** · 25 lines

```bash
bin/misc moniversive/packages/nanotasks/clarity.mis.nanotasks.clrty1_full_matrix_100.testnet.mis --check --compact-letters
```
...
| Outcomes | `seal_testnet_clrty1_matrix` |
| fn | — |
| EMBED 3..=6 | no |
...
```mis
// clarity.mis.nanotasks.clrty1_full_matrix_100.testnet — CLRTY-1 100-task matrix network scope (testnet)
...
module clarity.mis.nanotasks.clrty1_full_matrix_100.testnet {
  ...
  outcome seal_testnet_clrty1_matrix(ctx: Bytes) {
    require ctx != @0;
