# `moniversive/migrated/seo-kit-second/automations/browser/pattern_recog.mis`

> Generated 2026-07-26T17:14:13Z · module **`SeoKitSecondAutomationsBrowserPatternRecog`** · 30 lines

```bash
bin/misc moniversive/migrated/seo-kit-second/automations/browser/pattern_recog.mis --check --compact-letters
```
...
// Migrated from seo-kit-second/automations/browser/pattern_recog.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module SeoKitSecondAutomationsBrowserPatternRecog {

  embed gates 3..=6 {
    context: "MIS cutover of seo-kit-second/automations/browser/pattern_recog.py on clrty-1";
