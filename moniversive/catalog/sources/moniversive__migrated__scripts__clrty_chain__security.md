# `moniversive/migrated/scripts/clrty_chain/security.mis`

> Generated 2026-07-26T17:24:53Z · module **`ScriptsClrtyChainSecurity`** · 30 lines

```bash
bin/misc moniversive/migrated/scripts/clrty_chain/security.mis --check --compact-letters
```
...
// Migrated from scripts/clrty_chain/security.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsClrtyChainSecurity {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/clrty_chain/security.py on clrty-1";
