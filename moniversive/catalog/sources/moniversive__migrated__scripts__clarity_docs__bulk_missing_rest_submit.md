# `moniversive/migrated/scripts/clarity_docs/bulk_missing_rest_submit.mis`

> Generated 2026-07-26T17:14:13Z · module **`ScriptsClarityDocsBulkMissingRestSubmit`** · 30 lines

```bash
bin/misc moniversive/migrated/scripts/clarity_docs/bulk_missing_rest_submit.mis --check --compact-letters
```
...
// Migrated from scripts/clarity_docs/bulk_missing_rest_submit.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsClarityDocsBulkMissingRestSubmit {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/clarity_docs/bulk_missing_rest_submit.py on clrty-1";
