# `moniversive/migrated/scripts/clarity_docs/mcp_bulk_apply_runner.mis`

> Generated 2026-07-26T17:24:53Z · module **`ScriptsClarityDocsMcpBulkApplyRunner`** · 30 lines

```bash
bin/misc moniversive/migrated/scripts/clarity_docs/mcp_bulk_apply_runner.mis --check --compact-letters
```
...
// Migrated from scripts/clarity_docs/mcp_bulk_apply_runner.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsClarityDocsMcpBulkApplyRunner {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/clarity_docs/mcp_bulk_apply_runner.py on clrty-1";
