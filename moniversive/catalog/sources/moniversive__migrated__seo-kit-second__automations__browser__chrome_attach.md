# `moniversive/migrated/seo-kit-second/automations/browser/chrome_attach.mis`

> Generated 2026-07-26T17:24:53Z · module **`SeoKitSecondAutomationsBrowserChromeAttach`** · 30 lines

```bash
bin/misc moniversive/migrated/seo-kit-second/automations/browser/chrome_attach.mis --check --compact-letters
```
...
// Migrated from seo-kit-second/automations/browser/chrome_attach.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module SeoKitSecondAutomationsBrowserChromeAttach {

  embed gates 3..=6 {
    context: "MIS cutover of seo-kit-second/automations/browser/chrome_attach.py on clrty-1";
