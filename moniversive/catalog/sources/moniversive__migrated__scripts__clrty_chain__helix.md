# `moniversive/migrated/scripts/clrty_chain/helix.mis`

> Generated 2026-07-26T17:14:13Z · module **`ScriptsClrtyChainHelix`** · 30 lines

```bash
bin/misc moniversive/migrated/scripts/clrty_chain/helix.mis --check --compact-letters
```
...
// Migrated from scripts/clrty_chain/helix.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsClrtyChainHelix {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/clrty_chain/helix.py on clrty-1";
