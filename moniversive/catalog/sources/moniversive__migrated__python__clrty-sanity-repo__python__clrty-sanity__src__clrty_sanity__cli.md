...
// Migrated from python/clrty-sanity-repo/python/clrty-sanity/src/clrty_sanity/cli.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module PythonClrtySanityRepoPythonClrtySanitySrcClrtySanityCli {

  embed gates 3..=6 {
    context: "MIS cutover of python/clrty-sanity-repo/python/clrty-sanity/src/clrty_sanity/cli.py on clrty-1";
