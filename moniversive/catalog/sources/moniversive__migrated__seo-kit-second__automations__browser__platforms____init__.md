# `moniversive/migrated/seo-kit-second/automations/browser/platforms/__init__.mis`

> Generated 2026-07-26T17:24:53Z · module **`SeoKitSecondAutomationsBrowserPlatformsInit`** · 30 lines

```bash
bin/misc moniversive/migrated/seo-kit-second/automations/browser/platforms/__init__.mis --check --compact-letters
```
...
// Migrated from seo-kit-second/automations/browser/platforms/__init__.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module SeoKitSecondAutomationsBrowserPlatformsInit {

  embed gates 3..=6 {
    context: "MIS cutover of seo-kit-second/automations/browser/platforms/__init__.py on clrty-1";
