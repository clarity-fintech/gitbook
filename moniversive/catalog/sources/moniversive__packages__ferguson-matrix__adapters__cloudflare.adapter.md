# `moniversive/packages/ferguson-matrix/adapters/cloudflare.adapter.mis`

> Generated 2026-08-02T12:03:42Z · module **`CloudflareAdapter`** · 29 lines

```bash
bin/misc moniversive/packages/ferguson-matrix/adapters/cloudflare.adapter.mis --check --compact-letters
```
...
module CloudflareAdapter {
  ...
  invariant provider_id: adapter_provider == "cloudflare_workers_ai";
  invariant default_model_ref: default_model == "@cf";
  ...
  outcome invoke(model_id: Bytes, prompt: Bytes, context: Bytes) {
    ...
    constraint adapter_provider == "cloudflare_workers_ai";
  }
