# `moniversive/migrated/scripts/clrty_project/rpc_cli.mis`

> Generated 2026-07-26T17:24:53Z · module **`ScriptsClrtyProjectRpcCli`** · 30 lines

```bash
bin/misc moniversive/migrated/scripts/clrty_project/rpc_cli.mis --check --compact-letters
```
...
// Migrated from scripts/clrty_project/rpc_cli.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsClrtyProjectRpcCli {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/clrty_project/rpc_cli.py on clrty-1";
