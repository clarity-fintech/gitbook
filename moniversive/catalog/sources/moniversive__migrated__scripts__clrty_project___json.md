# `moniversive/migrated/scripts/clrty_project/_json.mis`

> Generated 2026-07-26T17:24:53Z · module **`ScriptsClrtyProjectJson`** · 30 lines

```bash
bin/misc moniversive/migrated/scripts/clrty_project/_json.mis --check --compact-letters
```
...
// Migrated from scripts/clrty_project/_json.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsClrtyProjectJson {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/clrty_project/_json.py on clrty-1";
