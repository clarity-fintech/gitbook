# `moniversive/migrated/python/clrty-sets/src/clrty_sets/cli.mis`

> Generated 2026-07-26T17:14:13Z · module **`PythonClrtySetsSrcClrtySetsCli`** · 30 lines

```bash
bin/misc moniversive/migrated/python/clrty-sets/src/clrty_sets/cli.mis --check --compact-letters
```
...
// Migrated from python/clrty-sets/src/clrty_sets/cli.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module PythonClrtySetsSrcClrtySetsCli {

  embed gates 3..=6 {
    context: "MIS cutover of python/clrty-sets/src/clrty_sets/cli.py on clrty-1";
