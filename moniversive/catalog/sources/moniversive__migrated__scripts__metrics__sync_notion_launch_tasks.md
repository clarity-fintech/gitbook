# `moniversive/migrated/scripts/metrics/sync_notion_launch_tasks.mis`

> Generated 2026-07-26T17:24:53Z · module **`ScriptsMetricsSyncNotionLaunchTasks`** · 30 lines

```bash
bin/misc moniversive/migrated/scripts/metrics/sync_notion_launch_tasks.mis --check --compact-letters
```
...
// Migrated from scripts/metrics/sync_notion_launch_tasks.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsMetricsSyncNotionLaunchTasks {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/metrics/sync_notion_launch_tasks.py on clrty-1";
