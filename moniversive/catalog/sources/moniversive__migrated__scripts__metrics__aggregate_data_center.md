...
// Migrated from scripts/metrics/aggregate_data_center.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsMetricsAggregateDataCenter {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/metrics/aggregate_data_center.py on clrty-1";
