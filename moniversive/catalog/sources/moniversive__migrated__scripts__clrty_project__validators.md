...
// Migrated from scripts/clrty_project/validators.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsClrtyProjectValidators {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/clrty_project/validators.py on clrty-1";
