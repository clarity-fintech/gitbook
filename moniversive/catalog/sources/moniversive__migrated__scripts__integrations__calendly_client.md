# `moniversive/migrated/scripts/integrations/calendly_client.mis`

> Generated 2026-07-26T17:14:13Z · module **`ScriptsIntegrationsCalendlyClient`** · 30 lines

```bash
bin/misc moniversive/migrated/scripts/integrations/calendly_client.mis --check --compact-letters
```
...
// Migrated from scripts/integrations/calendly_client.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsIntegrationsCalendlyClient {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/integrations/calendly_client.py on clrty-1";
