# `moniversive/migrated/scripts/clrty_chain/validators.mis`

> Generated 2026-07-26T17:24:53Z · module **`ScriptsClrtyChainValidators`** · 30 lines

```bash
bin/misc moniversive/migrated/scripts/clrty_chain/validators.mis --check --compact-letters
```
...
// Migrated from scripts/clrty_chain/validators.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsClrtyChainValidators {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/clrty_chain/validators.py on clrty-1";
