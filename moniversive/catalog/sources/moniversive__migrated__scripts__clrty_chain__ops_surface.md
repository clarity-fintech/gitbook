...
// Migrated from scripts/clrty_chain/ops_surface.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsClrtyChainOpsSurface {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/clrty_chain/ops_surface.py on clrty-1";
