# `moniversive/migrated/scripts/clarity-wallet/verify_wallet_nodes.mis`

> Generated 2026-07-26T17:24:53Z · module **`ScriptsClarityWalletVerifyWalletNodes`** · 30 lines

```bash
bin/misc moniversive/migrated/scripts/clarity-wallet/verify_wallet_nodes.mis --check --compact-letters
```
...
// Migrated from scripts/clarity-wallet/verify_wallet_nodes.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsClarityWalletVerifyWalletNodes {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/clarity-wallet/verify_wallet_nodes.py on clrty-1";
