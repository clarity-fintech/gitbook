# `moniversive/packages/ferguson-matrix/adapters/anthropic.adapter.mis`

> Generated 2026-08-02T12:03:42Z · module **`AnthropicAdapter`** · 29 lines

```bash
bin/misc moniversive/packages/ferguson-matrix/adapters/anthropic.adapter.mis --check --compact-letters
```
...
module AnthropicAdapter {
  ...
  invariant provider_id: adapter_provider == "anthropic";
  invariant default_model_ref: default_model == "claude-opus-5";
  ...
  outcome invoke(model_id: Bytes, prompt: Bytes, context: Bytes) {
    ...
    constraint adapter_provider == "anthropic";
  }
