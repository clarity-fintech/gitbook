# `moniversive/migrated/python/clrty-cif/tests/test_validate.mis`

> Generated 2026-07-26T17:14:13Z · module **`PythonClrtyCifTestsTestValidate`** · 30 lines

```bash
bin/misc moniversive/migrated/python/clrty-cif/tests/test_validate.mis --check --compact-letters
```
...
// Migrated from python/clrty-cif/tests/test_validate.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module PythonClrtyCifTestsTestValidate {

  embed gates 3..=6 {
    context: "MIS cutover of python/clrty-cif/tests/test_validate.py on clrty-1";
