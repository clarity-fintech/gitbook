...
// Migrated from scripts/clarity_docs/nav_graph.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsClarityDocsNavGraph {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/clarity_docs/nav_graph.py on clrty-1";
