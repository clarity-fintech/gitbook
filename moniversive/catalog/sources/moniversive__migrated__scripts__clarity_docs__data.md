# `moniversive/migrated/scripts/clarity_docs/data.mis`

> Generated 2026-07-26T17:14:13Z · module **`ScriptsClarityDocsData`** · 30 lines

```bash
bin/misc moniversive/migrated/scripts/clarity_docs/data.mis --check --compact-letters
```
...
// Migrated from scripts/clarity_docs/data.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsClarityDocsData {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/clarity_docs/data.py on clrty-1";
