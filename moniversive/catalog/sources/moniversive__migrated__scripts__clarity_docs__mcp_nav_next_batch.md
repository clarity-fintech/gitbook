# `moniversive/migrated/scripts/clarity_docs/mcp_nav_next_batch.mis`

> Generated 2026-07-26T17:14:13Z · module **`ScriptsClarityDocsMcpNavNextBatch`** · 30 lines

```bash
bin/misc moniversive/migrated/scripts/clarity_docs/mcp_nav_next_batch.mis --check --compact-letters
```
...
// Migrated from scripts/clarity_docs/mcp_nav_next_batch.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsClarityDocsMcpNavNextBatch {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/clarity_docs/mcp_nav_next_batch.py on clrty-1";
