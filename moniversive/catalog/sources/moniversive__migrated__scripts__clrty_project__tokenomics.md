# `moniversive/migrated/scripts/clrty_project/tokenomics.mis`

> Generated 2026-07-26T17:24:53Z · module **`ScriptsClrtyProjectTokenomics`** · 30 lines

```bash
bin/misc moniversive/migrated/scripts/clrty_project/tokenomics.mis --check --compact-letters
```
...
// Migrated from scripts/clrty_project/tokenomics.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsClrtyProjectTokenomics {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/clrty_project/tokenomics.py on clrty-1";
