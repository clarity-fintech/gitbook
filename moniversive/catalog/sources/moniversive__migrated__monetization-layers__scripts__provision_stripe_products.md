# `moniversive/migrated/monetization-layers/scripts/provision_stripe_products.mis`

> Generated 2026-07-26T17:14:13Z · module **`MonetizationLayersScriptsProvisionStripeProducts`** · 30 lines

```bash
bin/misc moniversive/migrated/monetization-layers/scripts/provision_stripe_products.mis --check --compact-letters
```
...
// Migrated from monetization-layers/scripts/provision_stripe_products.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module MonetizationLayersScriptsProvisionStripeProducts {

  embed gates 3..=6 {
    context: "MIS cutover of monetization-layers/scripts/provision_stripe_products.py on clrty-1";
