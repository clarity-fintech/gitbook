# `moniversive/migrated/python/clrty-site/src/clrty_site/__main__.mis`

> Generated 2026-07-26T17:14:13Z · module **`PythonClrtySiteSrcClrtySiteMain`** · 30 lines

```bash
bin/misc moniversive/migrated/python/clrty-site/src/clrty_site/__main__.mis --check --compact-letters
```
...
// Migrated from python/clrty-site/src/clrty_site/__main__.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module PythonClrtySiteSrcClrtySiteMain {

  embed gates 3..=6 {
    context: "MIS cutover of python/clrty-site/src/clrty_site/__main__.py on clrty-1";
