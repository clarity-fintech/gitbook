# `moniversive/migrated/scripts/metrics/sync_notion_data_center.mis`

> Generated 2026-07-26T17:24:53Z · module **`ScriptsMetricsSyncNotionDataCenter`** · 30 lines

```bash
bin/misc moniversive/migrated/scripts/metrics/sync_notion_data_center.mis --check --compact-letters
```
...
// Migrated from scripts/metrics/sync_notion_data_center.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsMetricsSyncNotionDataCenter {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/metrics/sync_notion_data_center.py on clrty-1";
