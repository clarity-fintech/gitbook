# `moniversive/migrated/python/clrty-sets/src/clrty_sets/__main__.mis`

> Generated 2026-07-26T17:14:13Z · module **`PythonClrtySetsSrcClrtySetsMain`** · 30 lines

```bash
bin/misc moniversive/migrated/python/clrty-sets/src/clrty_sets/__main__.mis --check --compact-letters
```
...
// Migrated from python/clrty-sets/src/clrty_sets/__main__.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module PythonClrtySetsSrcClrtySetsMain {

  embed gates 3..=6 {
    context: "MIS cutover of python/clrty-sets/src/clrty_sets/__main__.py on clrty-1";
