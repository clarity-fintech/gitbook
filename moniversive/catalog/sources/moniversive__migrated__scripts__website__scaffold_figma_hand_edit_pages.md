...
// Migrated from scripts/website/scaffold_figma_hand_edit_pages.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsWebsiteScaffoldFigmaHandEditPages {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/website/scaffold_figma_hand_edit_pages.py on clrty-1";
