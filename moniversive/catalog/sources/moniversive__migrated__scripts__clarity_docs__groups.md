# `moniversive/migrated/scripts/clarity_docs/groups.mis`

> Generated 2026-07-26T17:24:53Z · module **`ScriptsClarityDocsGroups`** · 30 lines

```bash
bin/misc moniversive/migrated/scripts/clarity_docs/groups.mis --check --compact-letters
```
...
// Migrated from scripts/clarity_docs/groups.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsClarityDocsGroups {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/clarity_docs/groups.py on clrty-1";
