# `moniversive/migrated/scripts/clarity_docs/patch_architecture_groups.mis`

> Generated 2026-07-26T17:14:13Z · module **`ScriptsClarityDocsPatchArchitectureGroups`** · 30 lines

```bash
bin/misc moniversive/migrated/scripts/clarity_docs/patch_architecture_groups.mis --check --compact-letters
```
...
// Migrated from scripts/clarity_docs/patch_architecture_groups.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsClarityDocsPatchArchitectureGroups {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/clarity_docs/patch_architecture_groups.py on clrty-1";
