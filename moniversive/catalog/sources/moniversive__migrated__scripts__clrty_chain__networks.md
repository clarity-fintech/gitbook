# `moniversive/migrated/scripts/clrty_chain/networks.mis`

> Generated 2026-07-26T17:14:13Z · module **`ScriptsClrtyChainNetworks`** · 30 lines

```bash
bin/misc moniversive/migrated/scripts/clrty_chain/networks.mis --check --compact-letters
```
...
// Migrated from scripts/clrty_chain/networks.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsClrtyChainNetworks {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/clrty_chain/networks.py on clrty-1";
