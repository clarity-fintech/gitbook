# `moniversive/migrated/scripts/website/upgrade_public_shell.mis`

> Generated 2026-07-26T17:14:13Z · module **`ScriptsWebsiteUpgradePublicShell`** · 30 lines

```bash
bin/misc moniversive/migrated/scripts/website/upgrade_public_shell.mis --check --compact-letters
```
...
// Migrated from scripts/website/upgrade_public_shell.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsWebsiteUpgradePublicShell {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/website/upgrade_public_shell.py on clrty-1";
