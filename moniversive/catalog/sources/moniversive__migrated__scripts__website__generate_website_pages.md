# `moniversive/migrated/scripts/website/generate_website_pages.mis`

> Generated 2026-07-26T17:24:53Z · module **`ScriptsWebsiteGenerateWebsitePages`** · 30 lines

```bash
bin/misc moniversive/migrated/scripts/website/generate_website_pages.mis --check --compact-letters
```
...
// Migrated from scripts/website/generate_website_pages.py → .mis (CLRTY-1 MIS cutover)
// Kind: clrty1_surface

module ScriptsWebsiteGenerateWebsitePages {

  embed gates 3..=6 {
    context: "MIS cutover of scripts/website/generate_website_pages.py on clrty-1";
