...
> Generated 2026-07-29T03:15:28Z · language space only (not CLRTY-1 chain ops)

| Trait | MIS behavior |
| --- | --- |
| **Extension** | `.mis` canonical (`.clrty` legacy host surface) |
| **Compiler kernel** | `misc` only — `bin/misc` (`make misc-build`) |
| **Letter-hash** | Rolling SHA-256 over typed letters ([letter-hash](letter-hash.md)) |
...
| **Index** | `mis_code_index.json` — Cursor tip-of-spear (150 `.mis` sources) |
