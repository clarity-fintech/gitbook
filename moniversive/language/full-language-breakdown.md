...
> Generated 2026-07-26T18:05:15Z · **15** language modules · **60** outcomes · **84** invariants · **0** `fn` declarations
...
Full catalog by category: **[Session prompts — 48h](../learn/session-prompts-48h.md)** · [Build from session inputs](build-from-session-inputs.md).
